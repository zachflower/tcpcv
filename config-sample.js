			...
			data: [
				{
					...
					body: "Designed and built web applications for freelance clients; Primarily developed in PHP; Provided professional guidance to help clients reach technical goals."
				},
				{
					header: [
						"Buffer",
